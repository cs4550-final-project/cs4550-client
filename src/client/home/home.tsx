...
import { AccordionSummary, Typography, AccordionDetails, Checkbox, Button, Input } from "@mui/material";
        ...
        <Grid item xs={9} className={styles.browseContainer}>
          <div className={styles.searchBarContainer}>
            <TextField 
              ...
              placeholder="placeholder asjkd" variant="outlined" className={styles.searchInput}
